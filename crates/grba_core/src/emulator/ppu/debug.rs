...
impl PPU {
    ...
    pub fn read_io_dbg(&mut self, address: MemoryAddress) -> u8 {
        ...
        match address {
            ...
            0x10..=0x11 => self.bg_scrolling[0].x.to_le_bytes()[addr % 2],
            0x12..=0x13 => self.bg_scrolling[1].x.to_le_bytes()[addr % 2],
            0x14..=0x15 => self.bg_scrolling[2].x.to_le_bytes()[addr % 2],
            0x16..=0x17 => self.bg_scrolling[3].x.to_le_bytes()[addr % 2],
            0x18..=0x19 => self.bg_scrolling[0].y.to_le_bytes()[addr % 2],
            0x1A..=0x1B => self.bg_scrolling[1].y.to_le_bytes()[addr % 2],
            0x1C..=0x1D => self.bg_scrolling[2].y.to_le_bytes()[addr % 2],
            0x1E..=0x1F => self.bg_scrolling[3].y.to_le_bytes()[addr % 2],
