...
impl PPU {
    ...
    pub fn write_io(&mut self, address: MemoryAddress, value: u8) {
        ...
        match address {
            ...
            0x12..=0x13 => self.bg_scrolling[0].y.update_byte_le(addr % 2, value),
            0x14..=0x15 => self.bg_scrolling[1].x.update_byte_le(addr % 2, value),
            0x16..=0x17 => self.bg_scrolling[1].y.update_byte_le(addr % 2, value),
            0x18..=0x19 => self.bg_scrolling[2].x.update_byte_le(addr % 2, value),
            0x1A..=0x1B => self.bg_scrolling[2].y.update_byte_le(addr % 2, value),
            0x1C..=0x1D => self.bg_scrolling[3].x.update_byte_le(addr % 2, value),
