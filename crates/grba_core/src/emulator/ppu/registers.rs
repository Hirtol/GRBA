...
pub const VCOUNT_START: MemoryAddress = 0x0400_0006;
pub const VCOUNT_END: MemoryAddress = 0x0400_0007;
...
#[derive(Debug, BitfieldSpecifier, enum_iterator::Sequence, PartialEq, Clone, Copy)]
#[bits = 3]
pub enum BgMode {
    Mode0 = 0b000,
    Mode1 = 0b001,
